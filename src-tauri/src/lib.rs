...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(|app| {
            ...
            let runtime = modules::orchestration::OrchestrationRuntime::default();
            let coordinator = modules::orchestration::coordinator::RunCoordinator::new(
                app.handle().clone(),
                store.clone(),
                runtime.clone(),
            );
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            modules::orchestration::commands::orchestration_request_final_merge,
            modules::orchestration::commands::orchestration_decide_final_merge,
            ...
            modules::orchestration::commands::orchestration_get_run_worktree,
            modules::orchestration::commands::orchestration_get_integration_evidence,
            modules::orchestration::commands::orchestration_cleanup_run_worktrees,
            modules::orchestration::commands::orchestration_reconcile_run,
            modules::orchestration::commands::orchestration_schedule_run,
            modules::orchestration::commands::orchestration_list_run_events_after,
            ...
            modules::orchestration::extensions::orchestration_save_mcp_server_with_secret,
