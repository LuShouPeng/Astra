...
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 更新日期    | 2026-07-25                                                                                                                                                                                                                                                                                                                                                               |
| 当前里程碑  | **M8 实现完成**（M7 Codex 原生恢复；M8 回归/构建/文档完成。Playwright 定位器修复后的最终复跑待授权）                                                                                                                                                                                                                                                                     |
...
| 前端测试    | **180/180 全绿**（46 files；Windows 下限制 `--maxWorkers=2` 避免 worker EPERM/满载超时）                                                                                                                                                                                                                                                                                 |
| 后端测试    | **22/22 全绿**（新增 Codex resume argv）                                                                                                                                                                                                                                                                                                                                 |
